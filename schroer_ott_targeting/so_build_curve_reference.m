function curve = so_build_curve_reference(component, direction, iterateCount, cfg)
%SO_BUILD_CURVE_REFERENCE Verbatim pre-optimisation adaptive curve builder.
%
%   This is the original so_build_curve implementation, preserved unchanged
%   so that the optimised so_build_curve can be verified against it.  It is
%   NOT called by the operational code path.  Its only consumer is
%   test_so_build_curve_equivalence.
