...
profile.stageRuntimeSeconds = [];
profile.replayRuntimeSeconds = [];
profile.directContainmentCandidates = 0;
profile.refinementCalls = 0;
profile.unresolvedSplits = 0;
profile.curvePointEvaluations = 0;
